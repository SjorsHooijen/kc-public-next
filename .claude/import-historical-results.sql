-- ============================================================================
-- IMPORT ALL HISTORICAL RESULTS (2018, 2019, 2022, 2023, 2024)
-- This script imports complete result data from all years
-- ============================================================================
...
-- Check how many results we currently have per year:
-- SELECT season, COUNT(*) as result_count FROM results GROUP BY season ORDER BY season;

-- Check how many standings entries we have per year:
-- SELECT season, COUNT(*) as standings_count FROM standings GROUP BY season ORDER BY season;

-- ============================================================================
-- SECTION 1: ENSURE RACES EXIST FOR ALL YEARS
-- ============================================================================

-- The races table should have entries for all years 2018-2024
-- Verify with: SELECT DISTINCT season FROM races ORDER BY season;

-- ============================================================================
-- SECTION 2: BULK INSERT MISSING RESULTS FROM 2018
-- ============================================================================

-- Insert 2018 Riethoven results (race_id 3)
...
-- Insert 2018 Hapert results (race_id 4)
INSERT INTO results (race_id, season, position, rider_name, points, bib_number, first_name, infix, last_name, sprint1, sprint2, total_points)
VALUES
...
-- ============================================================================
-- SECTION 3: RECALCULATE STANDINGS FOR ALL YEARS
-- ============================================================================

-- IMPORTANT: After importing all results, standings need to be recalculated.
--
-- Option 1: If you have a stored procedure or function that calculates standings:
-- CALL calculate_standings(2018);
-- CALL calculate_standings(2019);
-- CALL calculate_standings(2022);
-- CALL calculate_standings(2023);
-- CALL calculate_standings(2024);
--
-- Option 2: If standings are auto-calculated by the application, verify with:
-- SELECT season, COUNT(*) as standings_count FROM standings GROUP BY season ORDER BY season;
...
-- SELECT season, COUNT(*) as total_results FROM results GROUP BY season ORDER BY season;
-- SELECT season, COUNT(*) as total_standings FROM standings GROUP BY season ORDER BY season;

-- Check specific years:
-- SELECT season, name, COUNT(*) as result_count FROM results WHERE season IN (2018, 2019, 2022, 2023, 2024) GROUP BY season, name ORDER BY season, name;
